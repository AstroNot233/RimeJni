...
if(DEFINED ENV{RIME_PLUGINS})
    ...
    file(GLOB plugin_files "${RIME_PLUGIN_DIRS}/*")
...
foreach(plugin ${plugins})
    ...
    if(BUILD_MERGED_PLUGINS)
        ...
        add_library(${plugin_name}
            ${rime_plugin_boilerplate_src}
            ${plugin_objs}
        )
        target_link_libraries(${plugin_name} ${plugin_deps})
        set_target_properties(${plugin_name} PROPERTIES
            LIBRARY_OUTPUT_DIRECTORY ${RIME_BUILD_DIR}/lib/${RIME_PLUGINS_DIR}
            RUNTIME_OUTPUT_DIRECTORY ${RIME_BUILD_DIR}/bin/${RIME_PLUGINS_DIR}
        )
        if(XCODE_VERSION)
            set_target_properties(${plugin_name} PROPERTIES INSTALL_NAME_DIR "@rpath")
        endif(XCODE_VERSION)
        install(TARGETS ${plugin_name} DESTINATION ${RIME_BUILD_DIR}/${RIME_PLUGINS_DIR})
    endif()
endforeach(plugin)

set(rime_plugins_objs ${plugins_objs})
set(rime_plugins_deps ${plugins_deps})
